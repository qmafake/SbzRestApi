...
public class PostilionConnector_OG_No_Threading implements Runnable {
	
	private static Logger loggr = Logger.getLogger(PostilionConnector_OG_No_Threading.class);	
...
//					showMsgDetail(tbuff);										
			...
			loggr.error( "A timeout occured - Repeat reversals: \\TODO:");
